...
$id= $_GET['id'];
$query = "SELECT * FROM `admission_requests` where `id`= '$id'"; 
...
if ($result->num_rows > 0) 
            {
             ...
             $gaurdianid=  $row['gaurdianid'];
             $student_id=  $row['student_id'];

             $query = "SELECT * FROM `users_childern` where `email`= '$gaurdianid' and `name`= '$student_id'";     
  $result = $con->query($query);
...
?>
   ...
   <h1>Admin ID <?php echo $userid;?></h1>
        ...
        <section id="portfolio" class="portfolio section-padding ">
          <div class="container">
           ...
           <div class="col-12 col-md-12 col-lg-4">
            ...
            <a class="btn btn-success btn-lg btn-block mt-3" href="approvedRequest.php?id=<?php echo $row['id']; ?>" style="text-decoration: none;">Approve Request</a>    
                    <a class="btn btn-danger btn-lg btn-block mt-3" href="rejectRequest.php?id=<?php echo $row['id']; ?>" style="text-decoration: none;">Reject Request</a> 
