      ...
      <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="schools/s8.jpg" class="d-block w-100" alt="...">
            <div class="carousel-caption ">
              <h5>School finding application</h5>
          ...
          <div class="carousel-item">
            <img src="schools/s18.jpg" class="d-block w-100" alt="...">
            <div class="carousel-caption ">
              <h5>School finding application</h5>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nostrum eum magni doloribus maxime fuga, consequatur itaque, dignissim.</p>
              <p> <a href="#" class="btn btn-warning mt-3">learn more</a></p>
          ...
          <div class="carousel-item">
            <img src="schools/s20.png" class="d-block w-100" alt="...">
            <div class="carousel-caption ">
              <h5>School finding application</h5>
